...
Objective
Over two hours, build a lightweight app or script that demonstrates your ability to retrieve, reason over, and evaluate structured and unstructured data using the Rick & Morty API(https://rickandmortyapi.com/). The goal is not just to display data, but to show your approach to generating and evaluating AI-augmented outputs (summaries, explanations, or embeddings) grounded in that data.
